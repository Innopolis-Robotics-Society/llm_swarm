    ...
    "oneOf": [
        ...
        },
        {
            ...
            "properties": {
                ...
                "follower_ns": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                "offsets_x": {"type": "array", "items": {"type": "number"}, "minItems": 1},
                "offsets_y": {"type": "array", "items": {"type": "number"}, "minItems": 1},
                "reason": {"type": "string"},
            },
            "required": ["type", "formation_id", "leader_ns",
                         "follower_ns", "offsets_x", "offsets_y", "reason"],
        },
        {
            "type": "object",
            "properties": {
            ...
            "required": ["type", "formation_id", "reason"],
        },
        {
            "type": "object",
            "properties": {
